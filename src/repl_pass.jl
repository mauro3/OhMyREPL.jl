...
function untokenize_with_ANSI(io::IO, crayons::Vector{Crayon}, tokens::Vector{Token})
...
untokenize_with_ANSI(io::IO, rpc::PassHandler, tokens::Vector{Token}) = untokenize_with_ANSI(io, rpc.accum_crayons, tokens)
untokenize_with_ANSI(crayons::Vector{Crayon}, tokens::Vector{Token}) =
    untokenize_with_ANSI(STDOUT, crayons, tokens)
